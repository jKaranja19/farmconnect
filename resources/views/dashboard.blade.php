   ...
   <div class="side-bar">
     ...
     <div class="menu">
       ...
       <div class="item">
         ...
         <div class="sub-menu">
           <a href="/payment" class="sub-item"><i class="fas fa-plus"></i>Payment</a>
           <a href="/requestdelivery" class="sub-item"><i class="fas fa-plus"></i>Request Delivery</a>
         </div>
         
       </div>
       <div class="item"><a href="/track"><i class="fas fa-pin"></i>Track Produce</a></div>
